...
public class Application {
    ...
    * 추가로, 메소드 재정의(overriding)을 이용해서 부모가 가진 메소드를 재정의하는 것도 가능하다.
    *
    * */
    ...
    * 자식클래스가 정의한 메소드대로 동작하도록 구현
    * 몸체 부분을 새롭게 다시 작성하는 기술
    ...
    *
    * 2. 단점
    *   1-1. 부모클래스의 기능을 추가/변경할 시 자식클래스가 정상적으로 동작하는지에 대한
    *       예측이 힘들다.
    ...
    * */
    ...
    /*
    * 장점 단점 고려했을 때
    * 상속을 사용하는 때가 언제인지 정해서 잘 사용해야 한다.
    ...
    * 모든 객체는 자신이 수신한 메시지에 대한 응답을 해야하는 책임을 가지며, 그 책임의 규모는
    * 적절해야 한다. 적절한 책임을 가진 객체들이 서로 협력(메시지 수신과 응답)을 통해 프로그램을
    * 동작하는 것 => 객체지향 프로그램
    * */
