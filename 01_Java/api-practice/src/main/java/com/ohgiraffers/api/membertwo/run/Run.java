package com.ohgiraffers.api.membertwo.run;

import com.ohgiraffers.api.membertwo.Member;
...
public class Run {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < firstSplitArr.length; i++) {
            ...
            member.setMemberFirstName(secondSplitArr[1]);
            member.setMemberLastName(secondSplitArr[2]);
            member.setEmail(String.valueOf(secondSplitArr[3]));
            member.setGender(String.valueOf(secondSplitArr[4]));
//            LocalDate date = LocalDate.parse(secondSplitArr[4], DateTimeFormatter.ofPattern("yyyyMMdd"));
//            LocalTime time = LocalDate.parse(secondSplitArr[5], DateTimeFormatter.ofPattern("yyyyMMdd"));
//            LocalDateTime dateTime = LocalDate.parse(secondSplitArr[4], DateTimeFormatter.ofPattern("yyyyMMdd"));
