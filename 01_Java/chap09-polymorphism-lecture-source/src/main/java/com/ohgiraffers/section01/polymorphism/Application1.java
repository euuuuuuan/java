...
public class Application1 {
    ...
    * 하나의 메소드 호출로 객체별 각기 다른 방법으로 동작하게 할 수도 있다.
    *
    ...
    * */
    ...
    /*
    * 다형성 장점
    * 1. 여러 타입의 객체를 하나의 타입으로 관리할 수 있기에 유지 보수성과 생산성 증가
...
//        a2.bite();
        ...
        // instanceof 연산자
        // 레퍼런스 변수가 참조하는 실제 레퍼런스가 원하는 타입과 맞는지 비교하는 연산자
