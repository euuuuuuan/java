...
public class Application4 {
    public static void main(String[] args) {
        /*
        * 깊은 복사는 원본과 복사본, 둘 중 한가지 값을 변경해도 다른 하나에 영향을
        * 같은 값을 가지고 있지만, 서로 다른 배열이기 때문이다.
        * */
...
//            i += 10;
        ...
        /*
        * 주의 : for문은 배열에 인덱스에 차례로 접근할 때에는 편하게 사용할 수 있지만, 값변경은 불가능하다.
