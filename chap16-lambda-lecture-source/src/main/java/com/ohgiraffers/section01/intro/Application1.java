...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 명시적으로 한 개만 존재하는 경우 ()를 생략할 수 있으며,
         * 실행문이 한 줄인 경우 {}는 생략 가능하다.
         * */

        /*
         * 인터페이스에 정의된 추상메소드를 활용하는 방법 3가지
         * 1. 인터페이스를 상속받은 클래스를 정의하여 기능을 완성 후
         *   사용하는 방법
         * 2. 익명클래스를 활용해서 메소드를 정의 후 사용하는 방법
         * 3. 람다식을 활용하는 방법
         * */
        ...
        System.out.println("20과 30의 합 : " + c2.sumTwoNumbers(20, 30));

        // 3. 람다식을 활용한 방식
        Calculator c3 = (x, y) -> x + y;

        System.out.println("40과 50의 합 : " + c3.sumTwoNumbers(40, 50));
