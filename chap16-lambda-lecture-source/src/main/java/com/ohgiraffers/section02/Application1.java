...
public class Application1 {
    public static void main(String[] args) {
         ...
         * Predicate : 매개변수와 boolean 값을 반환하는 textXXX() 메소드를 가지고 있다. (매개변수를 활용해서 Boolean값 리턴)
         * */
...
//        Consumer<String> consumer = System.out::println;
        ...
        /* ObjIntConsumer<T>#accept(T t, long value) : void : 객체 T와 int 값을 받아 소비 */
        ObjIntConsumer<java.util.Random> objIntConsumer =
                (random, value) -> System.out.println("0 부터 " + value + " 전까지의 난수 발생 : " + random.nextInt(value));
