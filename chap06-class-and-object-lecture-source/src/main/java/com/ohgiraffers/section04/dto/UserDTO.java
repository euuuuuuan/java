...
public class UserDTO {
    ...
    * 이때, 사용할 수 있도록 규칙을 정해놓은 java 클래스를 자바빈(java bean)이라고 부른다.
    *
    ...
    * 4. 모든 멤버 변수에 접근가능한 설정자(setter)와 접근자(getter)가 public으로 작성되어 있어야함.
    ...
    * */
    ...
    /*
    * 설정자(setter)와 접근자(getter) -> 모든 필드에 대해 만들어야하고 public으로 만들어야 함.
    * */
