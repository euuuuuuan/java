...
public class Applicaiton1 {
    public static void main(String[] args) {
        ...
        * 자바에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로
        * 처리할 수 있도록 표준화된 방법을 제공하는 클래스들의 집합이다.
        * => 데이터를 효율적으로 저장하는 자료구조와 데이터를 처리하는
        * 알고리즘을 미리 구현해놓는 클래스
        * */

        /*
        * Collection FrameWork는 크게 3가지 인터페이스 중 한가지를 상속받아 구현해 두었다.
        * 1. List 인터페이스
        * 2. Set 인터페이스
        * 3. Map 인터페이스
        *
        ...
        * 배열의 단점 : 크기 변경 부가, 요소의 추가, 수정, 삭제, 정렬 복잡함
        ...
        * 중간 인덱스의 값을 삭제할 때 자동으로 인덱스를 하나씩 앞당긴다.
        * */
        list.remove(2);
        System.out.println("list = " + list);
        ...
        * -> Collection 사용되는 기능을 static 메소드로 구현한 클래스
        * */
...
//        Collections.reverse(stringList);
        ...
        /*
        * ArrayList에는 역순으로 정렬하는 기능이 제공되지 않는다.
        ...
        *
        * hashNext() : 다음 요소를 가지고 있는 경우 true, 더이상 요소가 없는 경우 false를 반환
        * next() : 다음 요소를 반환
        * */
