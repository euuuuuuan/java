...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("ch1과 ch2보다 크거나 같은지 비교 : " + (ch1 >= ch2)); //true
        System.out.println("ch1과 ch2보다 작은지 비교 : " + (ch1 < ch2)); //false
        System.out.println("ch1과 ch2보다 작거나 같은지 비교 : " + (ch1 <= ch2)); //false
...
//        System.out.println("bool1과 bool2보다 크거나 같은지 비교 : " + (bool1 >= bool2)); //true
//        System.out.println("bool1과 bool2보다 작은지 비교 : " + (bool1 < bool2)); //false
//        System.out.println("bool1과 bool2보다 작거나 같은지 비교 : " + (bool1 <= bool2)); //false

        // 문자열 비교
        // == 와 != 비교가 가능하지만 대소 비교는 불가능하다.
        String str1 = "java";
        String str2 = "java";
...
//        System.out.println("str1과 str2보다 큰지 비교 : " + (str1 > str2)); //true
//        System.out.println("str1과 str2보다 크거나 같은지 비교 : " + (str1 >= str2)); //true
//        System.out.println("str1과 str2보다 작은지 비교 : " + (str1 < str2)); //false
//        System.out.println("str1과 str2보다 작거나 같은지 비교 : " + (str1 <= str2)); //false
