...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   1-2. ||(논리 OR) 연산자 :
        *       -두 개의 논리식 중 둘 중 하나라도 참일 경우 True
        *       -둘 다 모두 거짓인 경우 False를 반환하는 연산
        * 2. 논리 고정 연산자
        *   피 연산자가 하나인 단항 연산자로, 피연산자의 결합 방향은 왼쪽에서 오른쪽이다.
        ...
        * */
        ...
        System.out.println("true와 flase의 논리 and 연산 : " + (true && false)); //false
        ...
        System.out.println("true와 flase의 논리 or 연산 : " + (true || false)); //true
